...
import 'package:web3dart/web3dart.dart';
  ...
  Future<String> submit(String functionName, List<dynamic> args, BuildContext context)async{
    Client httpClient;
    Web3Client ethClient;
    httpClient = Client();
    ethClient = Web3Client(
...
/*     Flushbar flush;
    Flushbar<bool>(
      title: "Hey Ninja",
      message: "A transaction happened on blockchain, Do you want to see its details?",
      icon: Icon(
        Icons.info_outline,
        color: Colors.blue,),
